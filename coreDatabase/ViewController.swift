...
class ViewController: UIViewController {
    ...
    var arrstudent: [EmployeeDetails] = []
    ...
    private func insertStudentDetaisls(){
        ...
        let studentEntity = NSEntityDescription.entity(forEntityName: "Employee", in: viewContext)!
    ...
    private func getStudentDetaisls(){
        ...
        do{
            ...
            for students in students as! [NSManagedObject] {
                ...
                let studentObject = EmployeeDetails(id: id as! Double, name: name as! String, address: address as! String)
            ...
            if arrstudent.count > 0 {
                ...
                let studentListViewController = storyBoard.instantiateViewController(withIdentifier: "EmployeeViewController") as! EmployeeViewController
                studentListViewController.arrEmployee = arrstudent
